-file("/usr/local/Cellar/erlang/R16B03/lib/erlang/lib/parsetools-2.0.10/include/leexinc.hrl", 0).
...
-module(yecclig_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("./yecclig_lexer.xrl", 22).

-file("/usr/local/Cellar/erlang/R16B03/lib/erlang/lib/parsetools-2.0.10/include/leexinc.hrl", 14).
...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 39 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 45, C =< 58 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 64 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 91, C =< 94 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 115 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(17, Ics, Line, Tlen+1, 1, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 120 ->
    yystate(17, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(17, Ics, Line, Tlen+1, 1, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(17, Ics, Line, Tlen+1, 1, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(17, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(0, [10|Ics], Line, Tlen, _, _) ->
    yystate(4, Ics, Line+1, Tlen+1, 8, Tlen);
...
-file("./yecclig_lexer.xrl", 7).
yyaction_0() ->
     { token, "TYPEDEF" } .

-compile({inline,yyaction_1/1}).
-file("./yecclig_lexer.xrl", 9).
yyaction_1(TokenChars) ->
     { token, { "identifier", TokenChars } } .

-compile({inline,yyaction_2/0}).
-file("./yecclig_lexer.xrl", 11).
yyaction_2() ->
     { token, "," } .

-compile({inline,yyaction_3/0}).
-file("./yecclig_lexer.xrl", 12).
yyaction_3() ->
     { token, ";" } .

-compile({inline,yyaction_4/0}).
-file("./yecclig_lexer.xrl", 13).
yyaction_4() ->
     { token, "(" } .

-compile({inline,yyaction_5/0}).
-file("./yecclig_lexer.xrl", 14).
yyaction_5() ->
     { token, ")" } .

-compile({inline,yyaction_6/0}).
-file("./yecclig_lexer.xrl", 16).
yyaction_6() ->
     skip_token .

-compile({inline,yyaction_7/0}).
-file("./yecclig_lexer.xrl", 17).
yyaction_7() ->
     skip_token .

-compile({inline,yyaction_8/1}).
-file("./yecclig_lexer.xrl", 18).
yyaction_8(TokenChars) ->
     { token, { bad, TokenChars } } .

-file("/usr/local/Cellar/erlang/R16B03/lib/erlang/lib/parsetools-2.0.10/include/leexinc.hrl", 282).
